<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $role = 'agency'; // Fixed role for this page
        ...
        try {
            ...
            header("Location: login.php?msg=" . urlencode("Agency Registration successful! Welcome to Obsidian Automotive."));
            exit();
...
<html lang="en">
<head>
    <meta charset="UTF-8"><title>Agency Sign Up | Obsidian Automotive</title>
...
<body>
    <div class="auth-card border-secondary">
        <h2 class="text-center mb-1 brand-logo">Obsidian Automotive</h2>
        <p class="text-center text-muted small mb-4">Partner Portal - Agency Registration</p>
        ...
        <form method="POST">
            <div class="mb-3">
                <label class="form-label text-gray small">Agency / Company Name</label>
                <input type="text" name="name" class="form-control" required>
            </div>
            <div class="mb-3">
                <label class="form-label text-gray small">Corporate Email Address</label>
            ...
            <div class="mb-4">
                <label class="form-label text-gray small">Business Contact Number</label>
                <input type="text" name="contact" class="form-control" placeholder="+1 (555) 000-0000" required>
            </div>
            <button type="submit" class="btn-pill btn-ghost w-100 fw-bold border-light text-light mt-1 mb-2">Register Agency</button>
            <p class="text-center mt-4 small text-muted">Looking to rent a car? <a href="register.php" class="text-white text-decoration-underline">Register as a customer</a></p>
            <p class="text-center mt-2 small text-muted">Already a partner? <a href="login.php" class="text-white text-decoration-underline">Log in</a></p>
        </form>
    </div>
</body>
</html>
